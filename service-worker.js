const CACHE = 'molazhi-erp-v1';
const ASSETS = ['/', '/index.html', '/offline.html', '/manifest.json', '/src/main.js', '/src/styles.css', '/src/data.js', '/src/store.js', '/src/ai.js', '/icons/icon-192.svg', '/icons/icon-512.svg'];
